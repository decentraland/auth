...
export const TestViewPage = () => {
  ...
  const views = useMemo(() => {
    return {
      ...
      manaTransfer: {
        label: 'MANATransferView',
        element: <MANATransferView manaData={manaData} isLoading={false} onDeny={() => undefined} onApprove={async () => undefined} />
      },
      manaTransferCanceled: { label: 'MANATransferCanceledView', element: <MANATransferCanceledView manaData={manaData} /> },
      manaTransferComplete: { label: 'MANATransferCompleteView', element: <MANATransferCompleteView manaData={manaData} /> },
      nftTransfer: {
        label: 'NFTTransferView',
        element: <NFTTransferView nftData={nftData} isLoading={false} onDeny={() => undefined} onApprove={async () => undefined} />
      },
      nftTransferCanceled: { label: 'NFTTransferCanceledView', element: <NFTTransferCanceledView nftData={nftData} /> },
      nftTransferComplete: { label: 'NFTTransferCompleteView', element: <NFTTransferCompleteView nftData={nftData} /> },
