    ...
    return (
      <Main component="main">
        ...
        <SuccessContainer>
          ...
          <ActionButton>
            <Button variant="contained" onClick={onTryAgain} startIcon={<ArrowBackIosNewTwoToneIcon fontSize="small" />} data-testid="mobile-auth-try-again-button">
              {t('common.try_again')}
            </Button>
          </ActionButton>
        </SuccessContainer>
  ...
  return (
    <Main component="main">
      ...
      <SuccessContainer>
        ...
        <ActionButton>
          <Button variant="contained" onClick={attemptDeepLink} startIcon={<LoginRoundedIcon fontSize="small" />} data-testid="mobile-auth-return-button">
