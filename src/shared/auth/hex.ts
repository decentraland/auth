...
// or bare string as the UTF-8 of its characters. Every place that decides whether a personal_sign
// message is bytes or text must use this one predicate, or the screen and the wallet would disagree.
